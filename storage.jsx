...
const Storage = {
  ...
  loadProfile() {
    try {
      return JSON.parse(localStorage.getItem(PROFILE_KEY)) || { name: 'Apprentie pâtissière', level: 'CAP 1ère année' };
    } catch (e) { return { name: 'Apprentie pâtissière', level: 'CAP 1ère année' }; }
  },
...
const GEMINI_API_KEY = 'AIzaSyDicrYJ9hYXnT2kS1xaVSouSBa8pUHP5rA';
